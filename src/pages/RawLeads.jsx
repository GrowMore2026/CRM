        ...
        {viewingCampaignId ? (
          <>
            ...
            <div style={{ overflowX: 'auto', background: 'var(--bg-secondary)', borderRadius: '12px', border: '1px solid var(--border-color)' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.85rem' }}>
                ...
                <tbody>
                  {filteredLeads.filter(l => l.campaign_id === viewingCampaignId).length === 0 ? (
                    <tr>
                    ...
                    filteredLeads.filter(l => l.campaign_id === viewingCampaignId).map(lead => (
          ...
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {(campaigns || []).length === 0 ? (
                <div className="card" style={{ padding: '3rem', textAlign: 'center', color: 'var(--text-muted)', background: 'var(--bg-secondary)', borderRadius: '12px', border: '1px solid var(--border-color)' }}>
