...
import { PieChart, Pie, Cell, BarChart, Bar, AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip as RechartsTooltip, ResponsiveContainer, Legend } from 'recharts';
...
const LoanAdminOverview = ({ hideHolidays }) => {
  const { currentUser, users, leads, dataLoading, loanRawLeads } = useApp();
