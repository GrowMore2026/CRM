...
const LoanClients = ({ filterStatus }) => {
  ...
  const filteredLoans = loanFiles.filter(loan => {
    ...
    if (!effectiveFilter && (loan.status === 'Rejected' || loan.status === 'Cheque Handover')) return false;
            ...
            <div style={{ display: 'flex', gap: '1.5rem', marginBottom: '2rem', fontSize: '0.9rem', color: 'var(--text-muted)', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <select 
                  ...
                  disabled={isReadOnly(viewingLoan)}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.9rem' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Login Date:</span> <input type="date" value={editForm.loginDate || ''} onChange={e => setEditForm({...editForm, loginDate: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Cheque Handover:</span> <input type="date" value={editForm.chequeHandoverDate || ''} onChange={e => setEditForm({...editForm, chequeHandoverDate: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.9rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Employment:</span> <input type="text" value={editForm.employmentType || ''} onChange={e => setEditForm({...editForm, employmentType: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Occupation:</span> <input type="text" value={editForm.occupation || ''} onChange={e => setEditForm({...editForm, occupation: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Employer:</span> <input type="text" value={editForm.employer || ''} onChange={e => setEditForm({...editForm, employer: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Monthly Income:</span> <input type="number" value={editForm.monthlyIncome || ''} onChange={e => setEditForm({...editForm, monthlyIncome: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Prop Value:</span> <input type="number" value={editForm.propertyValue || ''} onChange={e => setEditForm({...editForm, propertyValue: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Loan Amount:</span> <input type="number" value={editForm.loanAmount || ''} onChange={e => setEditForm({...editForm, loanAmount: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Down Pymt:</span> <input type="number" value={editForm.downPayment || ''} onChange={e => setEditForm({...editForm, downPayment: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: 'var(--text-muted)' }}>Total EMI:</span> <input type="number" value={editForm.totalEmi || ''} onChange={e => setEditForm({...editForm, totalEmi: e.target.value})} style={inputStyle} disabled={isEmployee} /></div>
                </div>
              </div>
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', fontSize: '0.9rem' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                    ...
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>PAN & Aadhaar:</span> <input type="checkbox" checked={editForm.docPanAadhaar || false} onChange={e => setEditForm({...editForm, docPanAadhaar: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>Salary Slips (6 months):</span> <input type="checkbox" checked={editForm.docSalarySlips || false} onChange={e => setEditForm({...editForm, docSalarySlips: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>Bank Statement (12m):</span> <input type="checkbox" checked={editForm.docBankStatement || false} onChange={e => setEditForm({...editForm, docBankStatement: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>ITR (3 Years):</span> <input type="checkbox" checked={editForm.docItr || false} onChange={e => setEditForm({...editForm, docItr: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>Business Financials:</span> <input type="checkbox" checked={editForm.docBusinessFinancials || false} onChange={e => setEditForm({...editForm, docBusinessFinancials: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                  </div>
                  
                  {/* Property Documents */}
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                    <div style={{ fontWeight: '600', color: 'var(--text-primary)', marginTop: '0.5rem' }}>Property Documents</div>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>Agreement to Sell:</span> <input type="checkbox" checked={editForm.docAgreementToSell || false} onChange={e => setEditForm({...editForm, docAgreementToSell: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>Sale Deed:</span> <input type="checkbox" checked={editForm.docSaleDeed || false} onChange={e => setEditForm({...editForm, docSaleDeed: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>Builder Agreement:</span> <input type="checkbox" checked={editForm.docBuilderAgreement || false} onChange={e => setEditForm({...editForm, docBuilderAgreement: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>Approved Plan:</span> <input type="checkbox" checked={editForm.docApprovedPlan || false} onChange={e => setEditForm({...editForm, docApprovedPlan: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                    <label style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: isReadOnly(viewingLoan) ? 'default' : 'pointer' }}><span style={{ color: 'var(--text-muted)' }}>OC/CC:</span> <input type="checkbox" checked={editForm.docOcCc || false} onChange={e => setEditForm({...editForm, docOcCc: e.target.checked})} disabled={isReadOnly(viewingLoan)} /></label>
                  </div>
                </div>
              </div>
